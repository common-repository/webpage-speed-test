...
if( is_admin() ) 
{
	if(isset($_POST['wst_submit'])) {
		if (isset( $_POST['wst_added'] ) && wp_verify_nonce($_POST['wst_added'], 'add-item') ) {
			function checkPageSpeed($url) { 
				...
				$stategy	= sanitize_text_field($_POST['wst_selct_option']);
				...
				$wst_Result_Data =	json_decode($results,true);  
...
<div class="wrap">
	<h2>Enter URL to Check Speed </h2>
		...
		<?php wp_nonce_field('add-item','wst_added'); ?>
			<table class="form-table" style="width: 100%">
				<tr valign="top">
					<th scope="row">Enter URL :</th>
					<td>
						<input name="txt_url" class="text" type="text" placeholder="URL" style="width:50%!important;"  VALUE="<?php if(isset($wst_Result_Data)) { echo  $wst_Result_Data['id']; } else {echo site_url(); }?>">
				...
				<tr valign="top">
					<th scope="row"></th>
					<td>
						<input type="submit" name="wst_submit" id="submit" class="button button-primary" value="Check Now" >
					</td>
				</tr>
			</table>
		</form>
...
<?php if(isset($wst_Result_Data)) {
	
	if($wst_Result_Data[responseCode] == 200) { ?>
	
	<p style="font-weight: bold;font-size: 16px;" class="score value warning">
		Page Score :<span class="hilight-nub"> <?php echo $wst_Result_Data['ruleGroups']['SPEED']['score']; ?> / 100</span>
	</p>
	
	<div class="clearfix"></div>
	<div class="score-button">
		<?php if(isset($wst_Result_Data['pageStats']['numberResources'])) { ?>
			<li class="hvr-wobble-vertical">Number Resources <?php echo $wst_Result_Data['pageStats']['numberResources'] ; ?></li>
			<?php } 
			if(isset($wst_Result_Data['pageStats']['numberHosts'])) { ?>
			
			<li class="hvr-wobble-vertical">Number Hosts <?php echo $wst_Result_Data['pageStats']['numberHosts']; ?></li>
			
			<?php } 
			if(isset($wst_Result_Data['pageStats']['totalRequestBytes'])) { ?>
			<li class="hvr-wobble-vertical">Total Request Bytes <?php echo $wst_Result_Data['pageStats']['totalRequestBytes']; ?></li>
			<?php } 
			if(isset($wst_Result_Data['pageStats']['numberStaticResources'])) { ?>
			<li class="hvr-wobble-vertical">Number Static Resources <?php echo $wst_Result_Data['pageStats']['numberStaticResources']; ?></li>
			<?php }
			if(isset($wst_Result_Data['pageStats']['htmlResponseBytes'])) { ?>
			<li class="hvr-wobble-vertical">HTML Response Bytes <?php echo $wst_Result_Data['pageStats']['htmlResponseBytes']; ?></li>
			<?php }
			if(isset($wst_Result_Data['pageStats']['textResponseBytes'])) { ?>
			<li class="hvr-wobble-vertical">Text Response Bytes <?php echo $wst_Result_Data['pageStats']['textResponseBytes']; ?></li>
			<?php }
			if(isset($wst_Result_Data['pageStats']['cssResponseBytes'])) { ?>
			<li class="hvr-wobble-vertical">CSS Response Bytes <?php echo $wst_Result_Data['pageStats']['cssResponseBytes']; ?></li>
			<?php }
			if(isset($wst_Result_Data['pageStats']['imageResponseBytes'])) { ?>
			<li class="hvr-wobble-vertical">Image Response Bytes <?php echo $wst_Result_Data['pageStats']['imageResponseBytes']; ?></li>
			<?php }
			if(isset($wst_Result_Data['pageStats']['javascriptResponseBytes'])) { ?>
			<li class="hvr-wobble-vertical">Javascript Response Bytes <?php echo $wst_Result_Data['pageStats']['javascriptResponseBytes']; ?></li>
			<?php }
			if(isset($wst_Result_Data['pageStats']['otherResponseBytes'])) { ?>
			<li class="hvr-wobble-vertical">Other Response Bytes <?php echo $wst_Result_Data['pageStats']['otherResponseBytes']; ?></li>
			<?php } 
			if(isset($wst_Result_Data['pageStats']['numberJsResources'])) { ?>
			<li class="hvr-wobble-vertical">Number Js Resources <?php echo $wst_Result_Data['pageStats']['numberJsResources']; ?></li>
			<?php } 
			if(isset($wst_Result_Data['pageStats']['numberCssResources'])) { ?>
			<li class="hvr-wobble-vertical">Number Css Resources <?php echo $wst_Result_Data['pageStats']['numberCssResources']; ?></li>
			<?php } ?>
						
	</div>
	
	<p style="font-weight: bold;font-size: 16px;" class="score value warning"> Some Script To increase pagespeed : </p>
	
	<button onclick="document.getElementById('id01').style.display='block'" class="w3-btn">GZIP Compression</button>
	...
	<button onclick="document.getElementById('id03').style.display='block'" class="w3-btn">Remove Query String</button>
		...
		<div class="wpaer-content">	
			...
			<button class="accordion">
				...
				<?php if($wst_Result_Data['formattedResults']['ruleResults']['EnableGzipCompression']['ruleImpact'] <= 0 ) { ?> 
					<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'/assets/check-mark-2-xxl.png'); ?> ">
				<?php } ?>
				<?php echo $wst_Result_Data['formattedResults']['ruleResults']['EnableGzipCompression']['localizedRuleName']; ?>
			...
			<?php 
			@$Enable_Com_title = $wst_Result_Data['formattedResults']['ruleResults']['EnableGzipCompression'] ['summary']['format']['urlBlocks'][0]['header']['format'];
			@$Enable_Com_Link = $wst_Result_Data['formattedResults']['ruleResults']['EnableGzipCompression'] ['summary']['format']['urlBlocks'][0]['header']['format']['args'][0]['value'];
			@$Enable_Com_size = $wst_Result_Data['formattedResults']['ruleResults']['EnableGzipCompression'] ['summary']['format']['urlBlocks'][0]['header']['format']['args'][1]['value'];
			@$Enable_Com_per = $wst_Result_Data['formattedResults']['ruleResults']['EnableGzipCompression'] ['summary']['format']['urlBlocks'][0]['header']['format']['args'][2]['value'];
			
			if($wst_Result_Data['formattedResults']['ruleResults']['EnableGzipCompression']['ruleImpact'] > 0 ) { ?> 
				<p class=""><b><?php echo $wst_Result_Data['formattedResults']['ruleResults']['EnableGzipCompression'] ['summary']['format'];?></b></p>
				...
				<?php 
				$Enable_Url_Array =	$wst_Result_Data['formattedResults']['ruleResults']['EnableGzipCompression']['urlBlocks'][0]['urls'];
			...
			<?php if($wst_Result_Data['formattedResults']['ruleResults']['LeverageBrowserCaching']['ruleImpact'] <= 0 ) { ?> 
				<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'/assets/check-mark-2-xxl.png'); ?> ">
			<?php } 
			
			echo @$wst_Result_Data['formattedResults']['ruleResults']['LeverageBrowserCaching']['localizedRuleName'];?>
			
			</button>
			
			<div class="panel">
			<?php if($wst_Result_Data['formattedResults']['ruleResults']['MinimizeRenderBlockingResources']['ruleImpact'] > 0 ) { ?> 
			<p><b><?php echo @$wst_Result_Data['formattedResults']['ruleResults']['LeverageBrowserCaching']['summary']['format'];?></b></p>
			<?php 
			...
			<?php 
			$Leverage_Array	= @$wst_Result_Data['formattedResults']['ruleResults']['LeverageBrowserCaching']['urlBlocks'][0]['urls'];
		...
		echo @$wst_Result_Data['formattedResults']['ruleResults']['MinimizeRenderBlockingResources']['localizedRuleName'];?>
		...
		$BlockJs = $wst_Result_Data['formattedResults']['ruleResults']['MinimizeRenderBlockingResources']['summary']['args'][0]['value'];
		$BlockCSS =	$wst_Result_Data['formattedResults']['ruleResults']['MinimizeRenderBlockingResources']['summary']['args'][1]['value'];
		?>
		...
		<p>
		<?php echo @$wst_Result_Data['formattedResults']['ruleResults']['MinimizeRenderBlockingResources']['urlBlocks'][0]['header']['format'];?>
		</p>
						  
		<p><b>Remove render-blocking JavaScript</b></p>
		<?php 
						  
		$BlockArray = $wst_Result_Data['formattedResults']['ruleResults']['MinimizeRenderBlockingResources']['urlBlocks'];
		$JScript_Dil = $wst_Result_Data['formattedResults']['ruleResults']['MinimizeRenderBlockingResources']['urlBlocks'][1]['urls'];
		$CSS_Dil = $wst_Result_Data['formattedResults']['ruleResults']['MinimizeRenderBlockingResources']['urlBlocks'][2]['urls'];
		...
		<?php if($wst_Result_Data['formattedResults']['ruleResults']['OptimizeImages']['ruleImpact'] <= 0 ) { ?> 
			<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'/assets/check-mark-2-xxl.png'); ?> ">
		<?php }
		echo @$wst_Result_Data['formattedResults']['ruleResults']['OptimizeImages']['localizedRuleName'];?>
		
		</button>
		
		<div class="panel">
		<?php if($wst_Result_Data['formattedResults']['ruleResults']['OptimizeImages']['ruleImpact'] > 0 ) { ?> 
		<p><b><?php echo @$wst_Result_Data['formattedResults']['ruleResults']['OptimizeImages']['summary']['format'];?></b></p>
		<?php 
			$opt_link =	$wst_Result_Data['formattedResults']['ruleResults']['OptimizeImages']['urlBlocks'][0]['header']['args'][0]['value'];
			$opt_size =	$wst_Result_Data['formattedResults']['ruleResults']['OptimizeImages']['urlBlocks'][0]['header']['args'][1]['value'];
			$opt_per =	$wst_Result_Data['formattedResults']['ruleResults']['OptimizeImages']['urlBlocks'][0]['header']['args'][2]['value'];
		?>
							
		<p><a href="<?php echo $opt_link;?>">Optimize the following images </a> to reduce their size by <?php echo $opt_size;?> ( <?php echo $opt_per;?> reduction )</p>
							
		<?php 
			$optimize_array = @$wst_Result_Data['formattedResults']['ruleResults']['OptimizeImages']['urlBlocks'][0]['urls'];
		...
		<?php if($wst_Result_Data['formattedResults']['ruleResults']['MainResourceServerResponseTime']['ruleImpact'] <= 0 ) { ?> 
			<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'/assets/check-mark-2-xxl.png'); ?> ">
		<?php }
		echo @$wst_Result_Data['formattedResults']['ruleResults']['MainResourceServerResponseTime']['localizedRuleName'];?>
		...
		$respo_time	= $wst_Result_Data['formattedResults']['ruleResults']['MainResourceServerResponseTime']['urlBlocks'][0]['header']['args'][0]['value'];
		...
		<?php if($wst_Result_Data['formattedResults']['ruleResults']['MinifyCss']['ruleImpact'] <= 0 ) { ?> 
			<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'/assets/check-mark-2-xxl.png'); ?> ">
		<?php }
		echo @$wst_Result_Data['formattedResults']['ruleResults']['MinifyCss']['localizedRuleName']; ?>
		
		</button>
		
		<div class="panel">
		<?php if($wst_Result_Data['formattedResults']['ruleResults']['MinifyCss']['ruleImpact'] > 0 ) { ?> 
		<p><b><?php echo $wst_Result_Data['formattedResults']['ruleResults']['MinifyCss']['summary']['format']; ?></b></p>
		
		<?php 
			$Minify_size = $wst_Result_Data['formattedResults']['ruleResults']['MinifyCss']['urlBlocks'][0]['header']['args'][1]['value'];
			$Minify_per	=	$wst_Result_Data['formattedResults']['ruleResults']['MinifyCss']['urlBlocks'][0]['header']['args'][2]['value'];
		...
		<?php 
			$minify_array = @$wst_Result_Data['formattedResults']['ruleResults']['MinifyCss']['urlBlocks'][0]['urls'];
			...
			<?php if($wst_Result_Data['formattedResults']['ruleResults']['MinifyHTML']['ruleImpact'] <= 0 ) { ?> 
				<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'/assets/check-mark-2-xxl.png'); ?> ">
			<?php }
			echo @$wst_Result_Data['formattedResults']['ruleResults']['MinifyHTML']['localizedRuleName'];?>
			...
			<p><b><?php echo $wst_Result_Data['formattedResults']['ruleResults']['MinifyHTML']['summary']['format'];?></b></p>
			<?php 
				$HTMinify_size	=	$wst_Result_Data['formattedResults']['ruleResults']['MinifyHTML']['urlBlocks'][0]['header']['args'][1]['value'];
				$HTMinify_per	=	$wst_Result_Data['formattedResults']['ruleResults']['MinifyHTML']['urlBlocks'][0]['header']['args'][2]['value'];
			...
			<?php 
				$minifyC_array = @$wst_Result_Data['formattedResults']['ruleResults']['MinifyHTML']['urlBlocks'][0]['urls'];
			...
			<?php if($wst_Result_Data['formattedResults']['ruleResults']['AvoidLandingPageRedirects']['ruleImpact'] <= 0 ) { ?> 
				<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'/assets/check-mark-2-xxl.png'); ?> ">
			<?php }
			echo @$wst_Result_Data['formattedResults']['ruleResults']['AvoidLandingPageRedirects']['localizedRuleName'];?>
			...
			$Total_Redi	= $wst_Result_Data['formattedResults']['ruleResults']['AvoidLandingPageRedirects']['summary']['args'][0]['value']; ?>
			...
			<?php 
				$re_array = @$wst_Result_Data['formattedResults']['ruleResults']['AvoidLandingPageRedirects']['urlBlocks'][0]['urls'];
				if(isset($re_array))
				{
				...
				{ 
					$urlsite_17 = "https://developers.google.com/speed/docs/insights/AvoidRedirects"; ?>
			...
			<?php if($wst_Result_Data['formattedResults']['ruleResults']['MinifyJavaScript']['ruleImpact'] <= 0 ) { ?> 
				<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'/assets/check-mark-2-xxl.png'); ?> ">
			<?php } 
			echo @$wst_Result_Data['formattedResults']['ruleResults']['MinifyJavaScript']['localizedRuleName']; ?> 
			...
			<?php if($wst_Result_Data['formattedResults']['ruleResults']['PrioritizeVisibleContent']['ruleImpact'] <= 0 ) { ?> 
				<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'/assets/check-mark-2-xxl.png'); ?> ">
			<?php }
			echo @$wst_Result_Data['formattedResults']['ruleResults']['PrioritizeVisibleContent']['localizedRuleName'];?>
			...
			<p><b>You have the above-the-fold content properly prioritized. Learn more about <a href="<?php echo esc_url( $urlsite_12 ); ?>" target="_blank">prioritizing visible content</b></a>.</p>
			...
			<?php
			$data_img = str_replace ("_", "/", $wst_Result_Data['screenshot']['data']);
		...
		<?php }	else { echo '<p style="font-weight: bold;font-size: 16px;" class="score value warning">Error : '.$wst_Result_Data['error']['message'].'</p>'; }
		 }
	}
	else
	{ ?> 
